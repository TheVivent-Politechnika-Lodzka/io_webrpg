...
|rozwinięcia    |    |     |     |     |    |     |    |     |#|Bieg                   |                           |
|############################################################|#|Przeskok w biegu       |                           |
|Drugorzędne    |  A | Żyw |  S  |  Wt | Sz | Mag | PO |  PP |#|Przeskok z Miejsca     |                           |
|Początkowe     |    |     |     |     |    |     |    |     |#|Lot                    |                           |
|Schemat rozwoju|    |     | --- | --- | -- |     | -- | --- |#|Ostrożny marsz         |                           |
|Aktualne       |    |     |     |     |    |     |    |     |#|Zwykły marsz           |                           |
|rozwinięcia    |    |     |     |     |    |     |    |     |#|swobodna podróż        |                           |
|##################################################################################################################|
|                            Broń                            |#|                        Pancerz                    |
|############################################################|#|###################################################|
...
|Cechy:                                                      |#|                                          |        |
|############################################################|#|###################################################|
|                   Umiejętności podstawowe                  |#|                    Zdolności                      |
|############################################################|#|###################################################|
...
|############################################################|#|###################################################|
|     Umiejętność   | wyk | +10% | +20% | wartość cechy  |typ|#|    Przedmiot       |Obc|           Opis           |
|###################|#####|######|######|################|###|#|####################|###|##########################|
|                   |     |      |      |                |   |#|                    |   |                          |
|                   |     |      |      |                |   |#|                    |   |                          |
|                   |     |      |      |                |   |#|                    |   |                          |
...
|               |    |     |     |     |    |     |    |     |#|---------------------------------------------------|
|------------------------------------------------------------|#|Miedziane Pensy[P]:                                |
|Drugorzędne    |  A | Żyw |  S  |  Wt | Sz | Mag | PO |  PP |#|###################################################|
|               |    |     |     |     |    |     |    |     |#|                  Doświadczenie                    |
|------------------------------------------------------------|#|###################################################|
|Umiejętności:                                               |#|Ogółem:                                            |
|                                                            |#|---------------------------------------------------|
